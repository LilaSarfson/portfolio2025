...
export default function SideBar (){
    return(
        <div className='hidden md:w-2/6 h-full right-0 fixed md:flex flex-col'>
            <div className='w-full h-full flex flex-col justify-center items-end'>   
                <ul className='flex flex-col gap-6 md:w-6/12 lg:w-5/12 2xl:w-3/12 h-2/6 items-end'>
