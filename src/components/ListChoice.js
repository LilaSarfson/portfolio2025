...
const [historyon, setHistoryOn] = useState(false)
    ...
    return(
        <div className="flex flex-col w-full h-full items-center text-2xl 2xl:text-3xl font-rale gap-4 sm:gap-16">
            <h3 className="uppercase text-center text-2xl sm:text-3xl 2xl:text-4xl">Every journy begins with a choice!</h3>
