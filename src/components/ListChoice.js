export default function ListChoice (){
    return(
        <>
            <ul className="flex flex-row justify-around w-full lg:h-4/6 items-center lg:text-xl xl:text-2xl font-mono">
                <li className="w-1/3 text-rojo text-end">Developing<span>⤸</span></li>
                <li className="font-mono uppercase lg:text-2xl text-center xl:text-4xl">Every journy begins with a choice!</li>
