    ...
    return(
        //blur o amarillo el bg ?
            <ul className={`font-pompi backdrop-blur-sm mb-0 font-bold flex self-center w-full justify-center ${props.direction} fixed bottom-0 xl:text-2xl 2xl:text-3xl`}>
                <li className={`flex ${props.directionLi} items-center justify-center`}><img className='xl:w-1/12 2xl:w-2/12 hover:rotate-180' src={Est} alt='Estrella'/><p className='hover:underline decoration-lila'>Watch Cv.</p></li>
