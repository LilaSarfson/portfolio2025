...
export default function ProjectDev (props){
    ...
    return(
        <>
        <div className={`flex ${props.direction} ${props.gradient} justify-center gap-4 p-6 w-5/6 m-auto drop-shadow-md`}>
            <img className='w-3/6 h-1/3  brightness-50 hover:brightness-100' src={`/${props.imagen}`}></img>    
