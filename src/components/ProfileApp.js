    ...
    return(
        <div className='text-center sm:text-center w-full'>
            <div className='flex flex-col sm:flex-row justify-center items-center sm:mt-0 sm:gap-12'>
                <div className='text-3xl sm:text-5xl 2xl:text-6xl'>
            ...
            <p className="font-pompi text-3xl sm:text-5xl 2xl:text-6xl">I'm a web developer and historian but, <br/> <span className="underline decoration-rojo ">every journy begins with a choice!</span></p>
         </div>
    )
}