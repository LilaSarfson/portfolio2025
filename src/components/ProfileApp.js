...
export default function ProfileApp (props){
    return(
        <div className='text-center sm:text-start'>
            <div className='flex flex-col sm:flex-row  mt-22 sm:mt-0'>
           ...
           <img className='w-7/12 w-5/12 xl:w-4/12 m-auto' src={props.src} />
            ...
            <p className="font-pompi text-4xl sm:text-5xl 2xl:text-6xl">I'm a web developer and historician but, <span className="underline decoration-rojo">currently<br/>I love more the first one.</span></p>
         </div>
    )
}