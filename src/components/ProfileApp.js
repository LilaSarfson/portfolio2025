    ...
    return(
        <div>
           ...
           <img className='lg:w-5/12 m-auto' src={props.src} />
            ...
            <p className="font-pompi lg:text-5xl">I'm a web developer and historician but, <span className="underline decoration-rojo">currently<br/>I love more the first one.</span></p>
         </div>
    )
}