    ...
    return(
        <section className="h-full flex align-start w-4/6 m-auto gap-4 font-mono mb-8 sm:mb-0">
            <div className='grid grid-cols-1 2xl:grid-cols-2'>
                <h2 className="sm:col-span-2 text-5xl 2xl:text-6xl w-full sm:w-3/6 underline decoration-lila font-bold text-center sm:text-start font-pompi">About me.</h2>
                ...
                <div className='flex flex-col gap-4 items-center'>
                    <img className='w-6/12' src={perfil}/>    
