...
export default function AboutMe (){
    ...
    return(
        <section className="motion-safe:animate-fadeIn flex flex-col lg:align-start w-5/6 sm:w-3/6 m-auto gap-4 font-mono py-32 "  id='about'>
            ...
            <div className='flex flex-col md:flex-row gap-4'>
                ...
                <div className='flex flex-col gap-4 items-center md:w-6/12 w-full'>
                    <img className='w-7/12 2xl:w-6/12 outline outline-offset-2 outline-4 outline-black' src={perfil}/>    
