...
export default function HistoryView (props){
    ...
    return(
        <section className={`${props.display ? '' : 'hidden'} motion-safe:animate-fadeIn w-5/6 sm:w-4/6 2xl:w-60p m-auto flex flex-col gap-10 justify-center py-44`} id='historian'>
            <h2 className="col-span-2 text-4xl 2xl:text-5xl underline decoration-azul font-bold text-center sm:text-start font-pompi">Somethings I've written.</h2>
